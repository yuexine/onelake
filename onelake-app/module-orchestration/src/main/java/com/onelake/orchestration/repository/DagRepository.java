...
public interface DagRepository extends JpaRepository<Dag, UUID> {
    ...
    @Query("""
            update Dag d
               set d.timezone = :timezone,
                   ...
                   d.misfirePolicy = :misfirePolicy,
                   d.dependencyWaitTimeoutMinutes = :dependencyWaitTimeoutMinutes,
    ...
    int updateSchedulingPolicy(@Param("id") UUID id,
                               ...
                               @Param("dependencyWaitTimeoutMinutes") int dependencyWaitTimeoutMinutes,
